                    ...
                    <tr style={{height:'10px'}}></tr>
                        ...
                        <tr>
                            ...
                            <td><Input style={{width:'700px', height:'25px'}} type="text" id="explanation" name="explanation" onChange={change}
                                 required="required" value={event.explanation} laceholder="개요를 입력해 주세요(90자 이하)" maxLength='90'/></td>
                        </tr>
                        <tr style={{height:'15px'}}></tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                            <div>
                                {fileImage && (<img alt="sample" src={fileImage} style={{ margin: "auto", width:'285px',height:'250px'}}/>)}
